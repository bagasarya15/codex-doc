    ...
    <>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          <div class="bg-white rounded-lg shadow-lg">
            <img src='./img/aset1.webp' class="w-full h-48 object-cover object-center"></img>
            <div class="p-4">
                <p class="text-lg font-semibold mb-2">ROG Phone 6 Diablo Immortal Edition</p>
          ...
          <div class="bg-white rounded-lg shadow-lg">
            <img src='./img/aset2.webp' class="w-full h-48 object-cover object-center"></img>
            <div class="p-4">
                <p class="text-lg font-semibold mb-2">ASUS Zenbook S 13 OLED (UX5304)</p>
                <div class="border-t-1 border border-black-500"></div>
                <p class="text-gray-700 mt-2">Harga Asus</p>
          ...
          <div class="bg-white rounded-lg shadow-lg">
            <img src='./img/aset3.webp' class="w-full h-48 object-cover object-center"></img>
            <div class="p-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-8">
          <div class="bg-white rounded-lg shadow-lg">
            <img src='./img/aset4.webp' class="w-full h-48 object-cover object-center"></img>
            <div class="p-4">
                <p class="text-lg font-semibold mb-2">
                    ROG Strix Scar 16 (2023) G634JY-I949M6T-O</p>
                <div class="border-t-1 border border-black-500"></div>
                <p class="text-gray-700 mt-2">Harga Asus</p>
          ...
          <div class="bg-white rounded-lg shadow-lg">
            <img src='./img/aset5.webp' class="w-full h-48 object-cover object-center"></img>
            <div class="p-4">
                <p class="text-lg font-semibold mb-2">Zenbook S 13 Flip OLED (UP5302, 12th Gen Intel)</p>
                <div class="border-t-1 border border-black-500"></div>
                <p class="text-gray-700 mt-2">Harga Asus</p>
          ...
          <div class="bg-white rounded-lg shadow-lg">
            <img src='./img/aset6.webp' class="w-full h-48 object-cover object-center"></img>
            <div class="p-4">
                <p class="text-lg font-semibold mb-2">ROG Flow X13 (2022) GV301RC-R735A6T-O</p>
                <div class="border-t-1 border border-black-500"></div>
                <p class="text-gray-700 mt-2">Harga Asus</p>
        ...
        <div className="grid col-1 bg-white h-80 shadow-xl mt-32">
        </div>
    </>
  )
}
